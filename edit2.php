...
{ 
  ...
  if(empty($year) || empty($rate)) {  
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE tbl_total SET year='$year', rate='$rate' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM tbl_total WHERE id=$id");
